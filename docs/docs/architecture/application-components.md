...
IMS Transaction Manager (IMS TM) provides transaction-processing services for the Bank of Z application. It processes banking requests, including customer management, account management, and transaction processing, using the IMS processing path.
